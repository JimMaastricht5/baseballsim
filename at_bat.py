...
class SimAB:
    ...
    def hbp(self) -> bool:
        ...
        # 2023 rate per plate appearance is 1.43%
    ...
    def outcome(self, pitching: Series, batting: Series, outcomes: OutCome, outs: int = 0,
    ...
    #
    def odds_ratio(self, hitter_stat: float64, pitcher_stat: float64,
