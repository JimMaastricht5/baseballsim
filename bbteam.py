...
DESCRIPTION: Manages a single baseball team's data, roster, lineup construction,
and in-game adjustments (like pitcher fatigue and substitutions) during simulation.
It handles the selection of the starting lineup and pitching rotation based on
player performance and manages the flow of in-game player state (condition, fatigue).
